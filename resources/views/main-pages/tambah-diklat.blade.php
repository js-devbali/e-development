...
@section('title', 'Diklat | Tambah Diklat')
        ...
        <div class="col-auto ml-auto text-right mt-n1">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('Diklat') }}">Diklat</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah diklat</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header p-2 d-flex justify-content-center justify-content-lg-start justify-content-sm-start">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" id="tabAccount" href="#account" data-toggle="tab">Tambah Diklat</a></li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="account">
                            <form action="" method="POST" class="form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group row">
                                    <label for="nik" class="col-sm-12 col-md-2 col-form-label">Penyelenggara<span class="text-danger">*</span></label>
                                    <div class="col-sm-12 col-md-10 my-auto">
                                        <input name="nik" type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" placeholder="Masukan nama penyelenggara">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="nama" class="col-sm-12 col-md-2 col-form-label">Biaya<span class="text-danger">*</span></label>
                                    <div class="col-sm-12 col-md-10 my-auto">
                                        <div class="input-group">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control" placeholder="Masukan biaya diklat" aria-label="Username">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mt-3">
                                    <div class="col-sm-12 text-end">
                                        <a href="{{ route('Diklat Result') }}" class="btn btn-sm btn-outline-success my-1">Simpan Data</a>
                                    </div>
                                </div>
                            </form>
                        </div>
